...
class _AnasayfaState extends State<Anasayfa> {
  ...
  Future<void> kurulum() async{
    ...
    await flp.initialize(kurulumAyari,onDidReceiveBackgroundNotificationResponse: bildirimTiklandiginda);
  }

  Future<void> bildirimTiklandiginda(NotificationResponse notificationResponse) async{
